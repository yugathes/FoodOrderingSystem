...
<?php
	...
	<div class="wrapper">
		<div class="middle">
			...
			<form class = "content" style="position:absolute;width: 40%;" action="Update.php" name="EditForm" method="POST" enctype="multipart/form-data">
		...
		<?php	}		else{	?>
						...
						<select id="service" name="category" required>
							<?php 
								...
								if($baris['category']=="5")	echo "<option value='4' selected>Drinks</option>";
