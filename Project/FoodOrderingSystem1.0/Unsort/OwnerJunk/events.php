          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="events.php">
                <i class="ni ni-controller text-info"></i>
                <span class="nav-link-text font-weight-bold text-info">Events & News</span>
              </a>
            </li>
          </ul>
          <!-- Divider -->
...
{?>  
    ...
    <div class="row">
        ...
        <div class="col-xl-2"><br>
            <img src="../admin/eventImg/<?php echo $row['eventImg']?>" style="width:100%;"><br><br>
        </div>
        <div class="col-xl-8">
            <br>
            <h3 class="text-white"><?php echo $row['name']?></h3>
            <p class="text-white"><?php echo $row['description']?></p>
            <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo $row['url']?>'">Learn More</button><br><br><br>
        </div>
        </div>
        </div>
        </div>
