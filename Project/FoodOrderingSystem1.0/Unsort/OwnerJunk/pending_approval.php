        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Leave Applications Approval </h3>
            </div>
              ...
              <table class="table align-items-center table-dark table-flush">
                ...
                <tbody class="list">
                  <?php
                    ...
                    $query="SELECT * FROM users WHERE dept = (SELECT dept FROM users WHERE username = '".$user."')";
                   // echo  $query;
                    $staff = mysqli_query($link, $query);
                    while($Srow= mysqli_fetch_array($staff, MYSQLI_BOTH))
                    {
                        ...
                        $queryGet = "select * from Cuti where sUsername = '".$staffDept."' AND management='0' AND status='0'ORDER BY datetimeReq DESC  ";	
                        //echo  $queryGet ;
                  ...
                  <tr>
                    ...
                    <!--<td>-->
                    <!--    <span class="status"><?php echo $row['sebab'];?></span>-->
                    <!--</td>-->
                    <td>
