...
<head>
  ...
  <meta name="description" content="STRICTLY FOR STAFFS OF SOUTHERN FINANCE.">
  <meta name="author" content="Creative Tim">
  <title>Admin Login | Sistem eCuti</title>
  <!-- Favicon -->
...
<body class="bg-gradient-success">
    ...
    <div class="container mt--8 pb-5 ">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="POST">
                ...
                <div class="text-center">
                  <input type="submit" class="btn btn-primary my-4" name="loginAdm" value="Sign In">
                </div>
              </form>
            </div>
          ...
          <div class="row mt-3">
            <div class="col-6">
              <a href="https://globalelite.com.my/cuti/introducer" class="text-white"><small>Manager Login</small></a>
            </div>
  ...
  <!-- Footer -->
  <footer class="py-5 bg-gradient-success" id="footer">
    <div class="container">
