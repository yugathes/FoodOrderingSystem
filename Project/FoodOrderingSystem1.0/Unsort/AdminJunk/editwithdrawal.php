...
<head>
  ...
  <title>Southern Finance | Edit Withdrawal</title>
  <!-- Favicon -->
          ...
          <div class="card bg-default">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-light text-uppercase ls-1 mb-1">Trade & Claim Programme</h6>
                  <h5 class="h2 text-white mb-0">Edit Withdrawal</h5>
                </div>
                <div class="col">
                ...
                $id = $_GET['id'];
            	$queryGet = "select * from priceLot WHERE logID='".$id."' ";	
...
//-------------------------------------------------------------------
                $name = $row['usrName'];
                $queryHP = "select Hp,email,address,name from introducer WHERE iName = '".$name."'";	
...
<div class="row">
    ...
    <label for="exampleFormControlInput1" class="h5 text-white mb-2" >Withdrawal ID</label>
    <input type="text" class="form-control" id="exampleFormControlInput1" name="logID" value="<?php echo $row['logID'];?>" disabled>
    <input type="hidden" name="logID" value="<?php echo $row['logID'];?>">
  </div></div>
    
    <div class="col">
    <div class="form-group">
    <label for="exampleFormControlInput1" class="h5 text-white mb-2" >Introducer Name</label>
  ...
  <div class="col">
    ...
    <select class="form-control" id="exampleFormControlSelect1" name="status">
      <option <?php if($desc == 1) echo "selected"; ?> value="1">Payment Pending</option>
      <option <?php if($desc == 2) echo "selected"; ?> value="2">Payment Approved</option>
      <option <?php if($desc == 3) echo "selected"; ?> value="3">Payment Cleared</option>
      <option <?php if($desc == 4) echo "selected"; ?> value="4">Payment Rejected</option>
    </select>
  </div>
  </div>
    ...
    <div class="col-xl-2">
    <div class="form-group">
    <label for="exampleFormControlInput1" class="h5 text-white mb-2" >Time of Withdrawal</label>
    <input type="text" class="form-control" id="exampleFormControlInput1" name="name" value="<?php echo $time;?>" disabled>
  </div></div>
    
    <div class="col">
    <div class="form-group">
    <label for="exampleFormControlInput1" class="h5 text-white mb-2" >Date of Withdrawal</label>
    <input type="text" class="form-control" id="exampleFormControlInput1" name="name" value="<?php echo $date;?>" disabled>
  </div></div>
  
  <div class="col">
  <div class="form-group">
    <label for="exampleFormControlInput1" class="h5 text-white mb-2" >Withdrawal Amount</label>
    <input type="text" class="form-control" id="exampleFormControlInput1" name="name" value="<?php echo $row['priceLot'];?>" disabled>
  </div>
  </div>
...
$ds = mysqli_connect('localhost', 'thesouth_yuga', '~6C^h8K3W+k1', 'thesouth_prizelot');
  // receive all input values from the form
	...
	$logID = mysqli_real_escape_string($ds, $_POST['logID']);
	
	$userUpdate = "UPDATE priceLot SET
				description = '".$status."' WHERE logID ='".$logID."'";
