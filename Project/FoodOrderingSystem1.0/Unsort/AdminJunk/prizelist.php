...
<head>
  ...
  <title>Southern Finance | Prizelist</title>
  <!-- Favicon -->
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="prizelist.php">
                ...
                <span class="nav-link-text font-weight-bold text-success">Prizes List</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  ...
                  <h5 class="h2 text-white mb-0">Add New Prize</h5>
                </div>
                <div class="col">
                ...
                <!-- Chart wrapper -->
                <div class="card-body">
                <form action="prizelist.php" method="POST" enctype='multipart/form-data'>

  <div class="row">

  <div class="col-xl-8">
  <div class="form-group">
    <label for="exampleFormControlInput1" class="h5 text-white mb-2" >Prize Name *</label>
    <input type="text" class="form-control" id="exampleFormControlInput1" name="name" placeholder="iPhone 11 Pro">
  </div>
  
    <div class="form-group">
    <label for="exampleFormControlInput1" class="h5 text-white mb-2" >Prize Description *</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description" placeholder="Get the latest model of the new iPhone 11 Pro"></textarea>
  </div>
...
<div class="col-xl-4">
  <div class="form-group">
    <label for="exampleFormControlInput1" class="h5 text-white mb-2" >Prize Lots *</label>
    <input type="number" class="form-control text-dark" id="exampleFormControlInput1" name="pLot" placeholder=0.00>
  </div>

  <div class="form-group">
    <label for="exampleFormControlSelect1" class="h5 text-white mb-2" >Prize Image *</label>
    <input type="file" class="form-control text-dark" id="exampleFormControlInput1" name="file" placeholder="10,15..">
  </div>
</div>
</div>

    <input class="btn btn-primary" type="submit" name="AddPrize" value="Add">
</form>
<?php
  ...
  // receive all input values from the form
    ...
    if (empty($pLot)) { array_push($errors, "Prize Lots is required"); }
   // if (empty($pImg)) { array_push($errors, "Prize Image is required"); }
    
    $prize_check_query = "SELECT * FROM prize WHERE name='$name' LIMIT 1";
    ...
    $destination = 'prizeimg/' . $filename;

    // get the file extension
    $extension = pathinfo($filename, PATHINFO_EXTENSION);

    // the physical file on a temporary uploads directory on the server
    $file = $_FILES['pImg']['prize'];
    ...
    if (!in_array($extension, ['jpeg', 'jpg', 'png'])) {
  	...
  	$query = "INSERT INTO prize(prizeID, name, description, pLot, pImg, total) 
  			  VALUES('$prizeID', '$name', '$description', '$pLot', '$filename', '0')";
  	$result= mysqli_query($link, $query);
  	if (!$result)
	{
	    die("Error:".mysqli_error($link));
	   $fail = "Please Check Add Price.";
        echo "<script type='text/javascript'>alert('$fail');
	    document.location='prizelist.php';
	    </script>"; 
	}
	else
	{
	    $sucess = "Prize Added Sucessful.";
...
?>
              ...
              <table class="table align-items-center table-dark table-flush">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="name">Prize Name</th>
                    <th scope="col" class="sort" data-sort="status">Prize Lots</th>
                    <th scope="col" class="sort" data-sort="status">Price Description</th>
                    <th scope="col" class="sort" data-sort="status">Amount Ordered</th>
                ...
                <?php
                    include "connection.php";
                    $count = 0;
                	$queryGet = "select * from prize order by prizeID";	
		...
		{$count++;?>  
                    ...
                    <td> <div class="avatar-group">
                        ...
                        <img alt="Image placeholder" src="prizeimg/<?php echo $row['pImg'];?>">
                        </a>
                    ...
                    <td>
                        <span class="status"><?php echo $row['pLot']?></span>
                      </span>
                    </td>
                   <td>
                    ...
                    <td>
                        <span class="status"><?php echo $row['total']?></span>
                      </span>
                    </td>
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          ...
                          <a class="dropdown-item" href="delete.php?przID=<?php echo $row['prizeID'];?>" onclick="return confirm('Are you sure?')">Delete</a>
                        </div>
                      </div>
                    </td>
                  </tr>
