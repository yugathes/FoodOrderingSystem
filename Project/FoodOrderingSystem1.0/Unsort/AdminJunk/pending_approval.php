              ...
              <table class="table align-items-center table-dark table-flush">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <!--<th scope="col" class="sort" data-sort="budget">Manager Approval</th>-->
                ...
                <?php
                	...
                	$queryGet = "select * from Cuti where management='1' AND admin='0' and status!='3' order by datetimeReq DESC";	
...
<!--<?php if ($row['management']=="0"){?>-->
<!--                            <i class="ni ni-tag text-sm text-yellow"></i><span class="name mb-0 text-sm text-yellow" value="0"> Processing</span></span>-->
<!--<?php } if ($row['management']=="1"){?>-->
<!--                            <i class="ni ni-tag text-sm text-green"></i><span class="name mb-0 text-sm text-green" value="1"> Approved</span>-->
<!--                            <?php } if ($row['management']=="2"){?>-->
<!--                            <i class="ni ni-tag text-sm text-red"></i><span class="name mb-0 text-sm text-red" value="2"> Rejected</span>-->
<!--<?php }?>-->
<!--                        </div>-->
<!--                      </div>-->
<!--                    </th>-->
                    ...
                    <!--    <span class="status h4 text-orange"> Processing</span>-->
                    <!--<?php } else if($row['admin']=="1") {?>-->
                      
                    <!--   <i class="ni ni-diamond text-success"></i>-->
                    <!--    <i class="bg-success"></i>-->
                    <!--    <span class="status h4 text-success"> Approved </span>-->
                    <!--<?php } else {} ?>-->
                     ...
                     <span class="status"><div class="row"><h5 class="text-white"> Manager : <?php if($row['management']==1) echo "&nbsp;<h5 class='text-success'> Approved</h5>";else echo "&nbsp;<h5 class='text-warning'> Processing";?></h5></span>
                      ...
                      <td> <span class="status"><div class="row"><h5 class="text-white"> <?php if($row['status']==1) echo "&nbsp;<h5 class='text-info'> Processing</h5>";else if($row['status']==2) echo "&nbsp;<h5 class='text-success'>Complete</h5>";else echo "&nbsp;<h5 class='text-warning'> Cancel";?></h5></span></div>
                        </td>

                    <td>
<a class="btn btn-primary btn-sm" href="report.php?cutiID=<?php echo $row['id'];?>">Print</a>                      
<a class="btn btn-success btn-sm" href="maklumat.php?cutiID=<?php echo $row['id'];?>">Full Details</a>
